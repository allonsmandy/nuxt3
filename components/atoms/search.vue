<template>
  <select @change="filter">
    <option value="plus-score">Mais populares</option>
    <option value="minus-score">Menos populares</option>
    <option value="cheap">Mais baratos</option>
    <option value="expensives">Mais caros</option>
    <option value="ascending">Ordem ascendente</option>
